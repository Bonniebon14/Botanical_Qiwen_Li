...
Meanwhile, we will remove control group observations and analyze walk and education separately; we will keep the control group observations and analyze the condition group; 
seeing if they give significantly different results.
